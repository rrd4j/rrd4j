...
/**
 * Thread pool used by {@link org.rrd4j.backend.spi.binary.RrdNioBackend} instances to periodically sync the mapped file to disk. Note that instances
...
public final class RrdSyncThreadPool
{
     ...
     * Defaults to {@value org.rrd4j.backend.spi.binary.RrdNioBackendFactory#DEFAULT_SYNC_CORE_POOL_SIZE} threads.
     */
    private final ScheduledExecutorService syncExecutor;

    /**
     * Creates a new RrdSyncThreadPool with a default pool size of {@value org.rrd4j.backend.spi.binary.RrdNioBackendFactory#DEFAULT_SYNC_CORE_POOL_SIZE}.
     */
