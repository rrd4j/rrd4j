...
public class PercentileTest {
    ...
    public void testSampleVDEFPercentile() throws Exception {
        ...
        RrdDb db = createRrdFile(fileName);
    ...
    private void updateDb(RrdDb db, long time, Double value) throws IOException {
        Sample s = db.createSample(time);
        s.setValue(0, value);
        s.update();
    }
