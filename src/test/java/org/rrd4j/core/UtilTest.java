...
public class UtilTest {
    ...
    public void testChildNodes() throws Exception {
        final String testXml =  "<sample>" +
                                ...
                                "   <other>5</other>" +
                                "</sample>";
        final Element root = Util.Xml.getRootElement(testXml);
    ...
    public void testGetValue() throws Exception {
        final Element intElement = Util.Xml.getRootElement("<sample>-8</sample>");
        Assert.assertEquals(-8, Util.Xml.getValueAsInt(intElement));
        final Element doubleElement = Util.Xml.getRootElement("<sample>14.3</sample>");
        Assert.assertEquals(14.3, Util.Xml.getValueAsDouble(doubleElement), 0);
        final Element longElement = Util.Xml.getRootElement("<sample>140000</sample>");
        Assert.assertEquals(140_000, Util.Xml.getValueAsLong(longElement));
        final Element boolElement = Util.Xml.getRootElement("<sample>yes</sample>");
    ...
    public void testGetDate() {
        final Date date = Util.getDate(515L);
    ...
    public void testGetCalendar(){
        final Calendar calendar1 = Util.getCalendar(100);
        Assert.assertEquals(100_000, calendar1.getTime().getTime());

        final Calendar calendar2 = Util.getCalendar(new Date(100));
        Assert.assertEquals(100, calendar2.getTime().getTime());

        final Calendar calendar3 = Util.getCalendar("100");
        Assert.assertEquals(100_000, calendar3.getTime().getTime());

        final Calendar calendar4 = Util.getCalendar("2019-01-02 03:04:05");
        Assert.assertEquals(1_546_398_245_000L, calendar4.getTime().getTime());
    }

    @Test
    public void testGetTimestamp() {
        final Date date = new Date(1501);
        Assert.assertEquals(2, Util.getTimestamp(date));

        final Calendar calendar = Util.getCalendar(200);
    ...
    public void testParseColor() {
        // Test without alpha
        final Color color1 = (Color) Util.parseColor("#AABBCC");
        ...
        // Test with alpha
        final Color color2 = (Color) Util.parseColor("#AABBCCDD");
        ...
        // Test without hash
        final Color color3 = (Color) Util.parseColor("AABBCCDD");
