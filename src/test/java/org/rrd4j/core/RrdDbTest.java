...
public class RrdDbTest {
    ...
    public void testRead1() throws IOException {
        RrdBackendFactory.getFactory("FILE").start();
        ...
        RrdBackendFactory.getFactory("FILE").stop();
    }
    ...
    public void testXml1Import() throws IOException {      
        ...
        RrdDb rrd = new RrdDb(testFolder.newFile("testxml1import.rrd").getCanonicalPath(), "xml:/" + url.getFile(), RrdBackendFactory.getFactory("MEMORY"));
        testRrdDbXml(rrd);
    ...
    public void testXml3Import() throws IOException {
        ...
        RrdDb rrd = new RrdDb(testFolder.newFile("testxml3import.rrd").getCanonicalPath(), "xml:/" + url.getFile(), RrdBackendFactory.getFactory("MEMORY"));
        testRrdDbXml(rrd);
        RrdBackendFactory.getFactory("MEMORY").stop();
    }
